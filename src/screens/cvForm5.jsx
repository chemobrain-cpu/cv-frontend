                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {formData.employmentHistory.map((exp, index) => (
                            <div key={index}>
                                ...
                                <button type="button" onClick={() => handleAddResponsibility(index)} className="px-4 py-2 text-white bg-blue-500 rounded-md hover:bg-blue-600">Add Responsibility</button>
                            </div>
                        ))}
                        ...
                        <button type="button" className="px-4 py-2 text-white bg-blue-500 rounded-md hover:bg-blue-600"  onClick={handleAddReference}>Add Reference</button>
